...
static const sensor_reg OV2640_YUV422[] = {
  { 0xFF, 0x00 },
  { 0x05, 0x00 },
  { 0xDA, 0x10 },
  { 0xD7, 0x03 },
...
static const sensor_reg OV2640_JPEG[] = {
  { 0xe0, 0x14 },
  { 0xe1, 0x77 },
  { 0xe5, 0x1f },
  { 0xd7, 0x03 },
...
/* JPG 640x480 */
static const sensor_reg OV2640_640x480_JPEG[] = {
	{0xff, 0x01},
	{0x11, 0x01},
...
/* JPG 800x600 */
static const sensor_reg OV2640_800x600_JPEG[] = {
	{0xff, 0x01},
	{0x11, 0x01},
	{0x12, 0x00}, // Bit[6:4]: Resolution selection//0x02为彩条
	{0x17, 0x11}, // HREFST[10:3]
...
/* JPG 1024x768 */
static const sensor_reg OV2640_1024x768_JPEG[] = {
	{0xff, 0x01},
	{0x11, 0x01},
	{0x12, 0x00}, // Bit[6:4]: Resolution selection//0x02为彩条
	{0x17, 0x11}, // HREFST[10:3]
...
static const sensor_reg OV2640_1280x1024_JPEG[] = {
	{0xff, 0x01},
	{0x11, 0x01},
	{0x12, 0x00}, // Bit[6:4]: Resolution selection//0x02为彩条
	{0x17, 0x11}, // HREFST[10:3]
